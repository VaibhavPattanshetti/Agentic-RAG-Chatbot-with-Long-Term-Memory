...
- This project was built as a learning/portfolio exercise to explore agentic patterns (planning, tool use, memory) with LangGraph.
- The MCP expense tracker integration is optional and demonstrates extending the agent with custom external tools — the app runs fine without it configured.
- Not intended for production use without further hardening (input validation, rate limiting, auth, etc.).
...
**Vaibhav** — built as part of exploring agentic RAG systems with LangGraph.
Feel free to open an issue or PR if you'd like to contribute or have suggestions!
